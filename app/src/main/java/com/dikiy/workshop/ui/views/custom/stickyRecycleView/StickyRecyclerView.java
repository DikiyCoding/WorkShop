package com.dikiy.workshop.ui.views.custom.stickyRecycleView;
...
/**
 * A {@link androidx.recyclerview.widget.RecyclerView} implementation which snaps the current visible
