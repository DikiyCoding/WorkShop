...
public class SettingsFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        slotManager.restore(
                ...
                savedInstanceState != null
                        ...
                        : SlotManager.NO_SLOT);
        ArrayList<Slot> slotList = new ArrayList<>(Arrays.asList(slotManager.getAllSlots()));
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.menu_clear_slot, menu);
        optionsMenu = menu;
    ...
    private class SlotManager {
        ...
        void restore(Context context, int oldSelectedSlot) {
            ...
            for (int i = 0; i < MAX_SLOTS; i++) {
                LoginBehavior loginBehavior =
                        (i == 0) ? LoginBehavior.NATIVE_WITH_FALLBACK : LoginBehavior.WEB_ONLY;
        ...
        void setCurrentUserSlot(int slot) {
    ...
    private class SlotAdapter extends ArrayAdapter<Slot> {
        ...
        SlotAdapter(ArrayList<Slot> slots) {
            super(requireActivity(), android.R.layout.simple_list_item_1, slots);
        }
        ...
        public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
            ...
            if (userName == null)
                userName = getString(R.string.facebook_empty_slot);

            String userId = slot.getUserId();
            ProfilePictureView profilePic = convertView.findViewById(R.id.slotPic);
            if (userId != null)
                profilePic.setProfileId(userId);
            else
                profilePic.setProfileId(null);

            TextView userNameTextView = convertView.findViewById(R.id.slotUserName);
            userNameTextView.setText(userName);

            final CheckBox currentUserCheckBox = convertView.findViewById(R.id.currentUserIndicator);
            currentUserCheckBox.setChecked(
                    slotManager.getSelectedSlot() == slot && slot.getUserInfo() != null);
            currentUserCheckBox.setOnClickListener(
                    view -> {
